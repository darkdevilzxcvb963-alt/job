...
"""
from sqlalchemy import Column, Integer, String, Boolean, DateTime, Enum as SQLEnum, Text, Float, ForeignKey
import uuid
...
class CandidateProfile(Base):
    ...
    preferred_job_types = Column(Text, nullable=True)  # JSON string (full-time, part-time, contract, etc)
